 ...
 */
@Singleton
public class ClientSessionSubscriptionService extends
        AbstractRaftService<ClientSessionSubscriptionOperation, ClientSessionSubscriptionResponse, ClientSessionSubscriptionClosure> {

    @Inject
    public ClientSessionSubscriptionService(
            final ClientSessionSubscriptionStateMachine stateMachine, final ClusterServerManager clusterServerManager) {
