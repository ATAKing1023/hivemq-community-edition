 ...
 * @since 2021/8/18
 */
public class ClientSessionSubscriptionRemoveRequestProcessor extends
        AbstractProcessor<ClientSessionSubscriptionOperation, ClientSessionSubscriptionResponse, ClientSessionSubscriptionClosure, ClientSessionSubscriptionService, ClientSessionSubscriptionRemoveRequest> {

    public ClientSessionSubscriptionRemoveRequestProcessor(final ClientSessionSubscriptionService raftService) {
        super(raftService);
    }

    @Override
    protected ClientSessionSubscriptionOperation transform(final ClientSessionSubscriptionRemoveRequest request) {
