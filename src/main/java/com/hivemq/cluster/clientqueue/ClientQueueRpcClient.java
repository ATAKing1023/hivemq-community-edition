 ...
 */
@Singleton
public class ClientQueueRpcClient extends AbstractRpcClient<ClientQueueResponse> {

    @Inject
    public ClientQueueRpcClient(final ClusterServerManager clusterServerManager) {
