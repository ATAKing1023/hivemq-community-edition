 ...
 * @author ankang
 */
class LocalPersistenceRheaKVModule extends SingletonModule<Class<LocalPersistenceRheaKVModule>> {
    ...
    LocalPersistenceRheaKVModule(@NotNull final Injector persistenceInjector) {
        super(LocalPersistenceRheaKVModule.class);
